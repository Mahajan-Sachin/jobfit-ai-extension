...
$response = Invoke-RestMethod -Uri "https://jobfit-ai-extension-6bun9lmej-mahajan-sachins-projects.vercel.app/api/extract-skills?x-vercel-set-bypass-cookie=true&x-vercel-protection-bypass=xZnXIfJyxfdtYTnAKAgoEzrKUB5VbTd6" -Method Post -Body $body -ContentType "application/json"
